...
import { DataGridActionColumn, DataGridColumn, DataGridEnumColumn, DataGridQueryFilter, DataGridTextColumn, DefaultDataGrid } from '~/lib/datagrid'
			...
			<Binding>
				...
				<DefaultDataGrid entities="Project" toolbar={<DataGridQueryFilter />}>
					...
					<DataGridActionColumn>
						<Link to="project/detail(id: $entity.id)">
							<AnchorButton>View</AnchorButton>
						</Link>
					</DataGridActionColumn>
				</DefaultDataGrid>
			</Binding>
